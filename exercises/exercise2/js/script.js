...
function game() {
  ...
  if (currentPokemon == "charizard") {
    if (guess == undefined) {
      push();
      imageMode(CENTER);
      image(charizardsilhouetteimage, width / 2, height / 2, 450, 450);
      pop();
    } else {
      push();
      imageMode(CENTER);
      image(charizardimage, width / 2, height / 2, 450, 450);
      pop();
    }
  }
  ...
  if (currentPokemon == "eevee") {
    if (guess == undefined) {
      push();
      imageMode(CENTER);
      image(eeveesilhouetteimage, width / 2, height / 2, 350, 350);
      pop();
    } else {
      push();
      imageMode(CENTER);
      image(eeveeimage, width / 2, height / 2, 350, 350);
      pop();
    }
  }
  ...
  if (currentPokemon == "lugia") {
    if (guess == undefined) {
      push();
      imageMode(CENTER);
      image(lugiasilhouetteimage, width / 2, height / 2, 450, 450);
      pop();
    } else {
      push();
      imageMode(CENTER);
      image(lugiaimage, width / 2, height / 2, 450, 450);
      pop();
    }
  }
  if (currentPokemon == "gardevoir") {
    if (guess == undefined) {
      push();
      imageMode(CENTER);
      image(gardevoirsilhouetteimage, width / 2, height / 2, 400, 400);
      pop();
    } else {
      push();
      imageMode(CENTER);
      image(gardevoirimage, width / 2, height / 2, 400, 400);
      pop();
    }
  }
  ...
  if (currentPokemon == "rayquaza") {
    if (guess == undefined) {
      push();
      imageMode(CENTER);
      image(rayquazasilhouetteimage, width / 2, height / 2, 450, 450);
      pop();
    } else {
      push();
      imageMode(CENTER);
      image(rayquazaimage, width / 2, height / 2, 450, 450);
      pop();
    }
  }
  if (currentPokemon == "lucario") {
    if (guess == undefined) {
      push();
      imageMode(CENTER);
      image(lucariosilhouetteimage, width / 2, height / 2, 450, 450);
      pop();
    } else {
      push();
      imageMode(CENTER);
      image(lucarioimage, width / 2, height / 2, 450, 450);
      pop();
    }
  }
  ...
  if (currentPokemon == "greninja") {
    if (guess == undefined) {
      push();
      imageMode(CENTER);
      image(greninjasilhouetteimage, width / 2, height / 2, 400, 400);
      pop();
    } else {
      push();
      imageMode(CENTER);
      image(greninjaimage, width / 2, height / 2, 400, 400);
      pop();
    }
  }
  if (currentPokemon == "mimikyu") {
    if (guess == undefined) {
      push();
      imageMode(CENTER);
      image(mimikyusilhouetteimage, width / 2, height / 2, 350, 350);
      pop();
    } else {
      push();
      imageMode(CENTER);
      image(mimikyuimage, width / 2, height / 2, 350, 350);
      pop();
    }
  }
  ...
  if (guess == true) {
    ...
    text("Press SPACE to generate a new pokemon!", 600, 550);
  }
  pop();
}
