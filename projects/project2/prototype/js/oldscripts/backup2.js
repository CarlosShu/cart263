...
function draw() {
  ...
  textSize(15);
  fill(255, 255, 255);
  if (instructionstimer >= 0 && instructionstimer < 180) {
    text("USE WASD TO MOVE, JUMP, AND CROUCH", 640, 640);
  } else if (instructionstimer >= 180 && instructionstimer < 360) {
    text("HOLD SHIFT TO RUN", 640, 640);
  } else if (instructionstimer >= 360) {
    instructionstimer = 0;
    pop();
  }
}
