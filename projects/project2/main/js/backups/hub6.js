class Hub extends Phaser.Scene {
  ...
  objectProperties() {
    ...
    // Moveable Blocks.
    this.moveableBlock1.setScale(0.25);
    this.moveableBlock1.setPipeline("Light2D");
    this.moveableBlock1.setDragX(2500);
  ...
  colliders() {
    // Colliders
    this.physics.add.collider(this.ground, this.moveableBlock1);
