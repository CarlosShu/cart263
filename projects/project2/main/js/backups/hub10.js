class Hub extends Phaser.Scene {
  ...
  create() {
    ...
    this.bigBlockTall.create(-200, 550);
    ...
    this.movingPlatformX.create(5400, 50);

    this.platform.create(5200, 50);

    this.movingPlatformX.create(4800, 50);

    this.platform.create(4600, 50);

    this.movingPlatformX.create(4200, 50);

    this.platform.create(4000, 50);
  ...
  objectProperties() {
    ...
    // Big Tall Block.
    this.bigBlocKTall.children.iterateLocal("setScale", "0.25");
    this.bigBlockTall.children.iterateLocal("setPipeline", "Light2D");
  ...
  colliders() {
    ...
    this.physics.add.collider(this.ground, this.bigBlockTall);
    ...
    this.physics.add.collider(this.player, this.bigBlockTall);
    ...
    this.physics.add.collider(this.moveableBlock1, this.bigBlockTall);
